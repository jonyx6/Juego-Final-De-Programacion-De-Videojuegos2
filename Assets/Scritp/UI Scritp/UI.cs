...
public class UI : MonoBehaviour
{
    ...
    [Header("Tiempos De Espera Por Accion")]
    public float tiempoDeAccion1 = 0.15f;
    public float tiempoDeAccion2 = 3f;
    public float tiempoDeAccion3 = 0.7f;
    public float tiempoDeAccion4 = 1.5f;
    ...
    private void Update()
    {
        ...
        CargaBoton(boton1, KeyCode.R, tiempoDeAccion1);
        CargaBoton(boton2, KeyCode.E, tiempoDeAccion2);
        CargaBoton(boton3, KeyCode.W, tiempoDeAccion3);
        CargaBoton(boton4, KeyCode.Q, tiempoDeAccion4);
    }
